...
function rollRound(){
		hideButton();
		setTimeout(function(){scoreRound(roundArray[roundNumber])}, 1500);
		setTimeout(function(){showButton()}, 1500);
}
...
function resetButton(){
	...
	buttonReseter.onclick = function() { startGame () };
	changeButtonText("START THE LAVA!");
}
...
// Next goal: transition alerts into inner html box